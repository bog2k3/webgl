...
import { MeshRenderModes, MeshVertex } from "../mesh";
...
export class MeshRenderer {
    ...
    renderMesh(mesh, worldTransform, context) {
    ...
    async initialize() {
        const meshVertexShaderCode = await (await fetch("/data/shaders/mesh.vert")).text();
        const meshFragmentShaderCode = await (await fetch("/data/shaders/mesh-texture.frag")).text();
